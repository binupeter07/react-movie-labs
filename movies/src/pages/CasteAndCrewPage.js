...
const CastAndCrewPage = () => {
  ...
  const { data: castsAndCrew, } = useQuery(
    ["cast", { id:movieId }],
    getCast
  );
  return (
    <>
    {
        ...
        <div className="casts">
          ...
          >
            {
              castsAndCrew?.cast.map((item)=>{
                if(item?.profile_path){
                  return(

                  <SwiperSlide>
                    <img src={`https://image.tmdb.org/t/p/w500/${item.profile_path}`} alt="Thumbnail" />
